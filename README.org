...
#+begin_src
#+begin_mindmap :max-width auto :wrap-leaves nil :compacted nil :layout centered
                                                                                                            ╭─ centered ── this is centered
                                                                                             ╭─ two layouts ┼─ top ── and this is top
                                                                                             │              ╰─ switch with C-c m v
                                                                                             │            ╭─ :max-width <n> ── soft-wrap nodes at n chars
                                                                                             │            ├─ :max-width ┬─ compute based on the width of your window
                                                                                             ├─ wrap long ┤  auto       ╰─ and the depth of your map
                                                                                             │  nodes     ╰─ :wrap-leaves ┬─ nil ── don't wrap leaves at all
                                                                                             │                            ╰─ <p> ── p times longer than non-leaves
                                                                                             ├─ supports two-sided maps!
                                                                           ╭─ align mindmaps ┼─ point is ┬─ and preserved
                                                                           │                 │  tracked  ╰─ see the point in the middle of the node
                                                                           │                 │             ╭─ for large maps
                                                                           │                 ├─ compaction ┼─ subtrees can be shifted upwards
                                                                           │                 │             ╰─ if there is free space
                                                                           │                 │             ╭─ will fix small misalignments
                                                                           │                 │             │                ╭─ with a node in front of it
                                                                           │                 ╰─ robustness ┴─ if you edit a ┼─ and this mode's connectors shift
                                                                           │                                  node          ├─ it'll try to recover
                                                                           │                                                ╰─ see =recovery-drift= option
                              no rendering ─╮                              │             ╭─ =M-<up>/<down>= ── move up/down
 editing mode ─┬ between ── no discrepancy ─┤                              ├─ move nodes ┼─ =M-<left>/<right>= ── move up/down the tree
and view mode ─╯                            ├ text only ── « what can it » ┤             ╰─ works with subtrees
            as regular text ── can edit it ─┤                do?           │          ╭─ to org list ── =C-c m l=
                     no extra dependencies ─┤                              │          │              ╭─ =C-c m m=
                                     no js ─╯                              ├─ convert ┤              ├─ but map        ── yet
                                                                           │          ╰─ from a list ╯  settings from 
                                                                           │                            the header are
                                                                           │                            not saved     
                                                                           │                             ╭─ Chinese ── 你好世界
                                                                           │           ╭─ variable width ┼─ Japanese ── こんにちは世界
                                                                           │           │  chars          ├─ Korean ── 안녕하세요
                                                                           │           │                 ╰─ but you'll need a CJK monospace font
                                                                           ├─ supports ┤                ╭─ nodes ── font properties
                                                                           │           │                ├─ connectors ── and         ── but better it use the same bg
                                                                           │           ╰─ customization ┤                whitespaces
                                                                           │                            ╰─ root       ── =M-x customize-group org-mindmap=
                                                                           │                               delimiters
                                                                           │       ╭─ M-ret to edit ┬─ add nodes on the right side
                                                                           │       │  a node        ╰─ then move to the left one
                                                                           │       ├─ start typing ── then M-ret ── and continue in minibuffer
                                                                           ╰─ tips ┼─ use footnotes ┬─ for the long blocks
                                                                                   │                ╰─ [fn:1]
                                                                                   ╰─ if you need ── and they're ── consider setting =alloc-gc-cons-percentage= option to 0.5-0.7
                                                                                      large maps     laggy      
#+end_mindmap
#+end_src
